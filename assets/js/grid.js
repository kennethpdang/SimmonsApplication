...
// Rotation angles (in radians) for a gentler tilt or CHANGE THIS
const angleX = -Math.PI / 2.8;
const angleY = 0;
const angleZ = 0;

// Scale for drawing (since amplitude is small, we can increase scale a bit) CHANGE THIS 
const scale3D = 30;
...
function drawGrid(t) {
    ...
    ctx.fillStyle = "#212121"; // Dark gray background
